...
- (void)testPhoneInfo
{
    ...
    XCTAssertTrue(typeSimulator, @"The device type should be iPhone Simulator.");
    // 设备系统版本号 e.g. @"12.0.1"
    ...
    XCTAssertTrue(systemVersionValue >= 9, @"The device system should be greater than iOS 9.");
    // 设备系统名称 e.g. @"iOS"
