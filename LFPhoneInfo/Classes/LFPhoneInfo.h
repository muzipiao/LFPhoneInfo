...
@property(class, nonatomic, copy, readonly) NSString *deviceTypeString;
// 设备系统版本号 e.g. @"12.0.1"
@property(class, nonatomic, copy, readonly) NSString *deviceSystemVersion;
// 设备系统名称 e.g. @"iOS"
@property(class, nonatomic, copy, readonly) NSString *deviceSystemName;
...
@property(class, nonatomic, assign, readonly) LFDeviceType deviceType;
// 当前设备用户设置的名称，设置->通用->关于本机->名称 e.g. "My iPhone"
@property(class, nonatomic, copy, readonly) NSString *deviceSettingName;
// 判断当前设备是不是iPhone，YES 是 iPhone 设备，NO不是
@property(class, nonatomic, assign, readonly) BOOL deviceIsIPhone;
// 判断当前设备是不是iPad，YES 是 iPad 设备，NO不是
@property(class, nonatomic, assign, readonly) BOOL deviceIsIPad;
// 判断当前设备是不是iPod，YES 是 iPod 设备，NO不是
@property(class, nonatomic, assign, readonly) BOOL deviceIsIPod;
// 判断当前设备是不是模拟器，YES 是 模拟器，NO不是
@property(class, nonatomic, assign, readonly) BOOL deviceIsSimulator;
// 当前设备电池电量百分比，取值范围 0 至 1.0，如果返回 -1.0 表示无法识别电池
@property(class, nonatomic, assign, readonly) CGFloat deviceBatteryLevel;
// 屏幕逻辑尺寸 e.g. 逻辑像素尺寸为 2208x1242（屏幕实际物理像素尺寸是 1920x1080）
@property(class, nonatomic, assign, readonly) CGSize deviceLogicalScreenSize;
// 当前设备总内存, 返回值为兆 MB, e.g. iPhone 总内存为 2048 MB
@property(class, nonatomic, assign, readonly) CGFloat deviceTotalMemory;
// 当前 App 占用的设备内存，返回值为兆 MB, e.g. 占用 43 MB
@property(class, nonatomic, assign, readonly) CGFloat appTakeUpMemory;
// 当前磁盘总空间，返回值为兆 MB，0为异常 e.g. 总共 16 GB 即 16384 MB
@property(class, nonatomic, assign, readonly) CGFloat deviceTotalDisk;
// 当前磁盘未使用，返回值为兆 MB，0为异常 e.g. 空闲 2200 MB
@property(class, nonatomic, assign, readonly) CGFloat deviceFreeDisk;
// 当前磁盘已经使用，返回值为兆 MB，0为异常 e.g. 已使用 2200 MB
@property(class, nonatomic, assign, readonly) CGFloat deviceUsedDisk;
/**
...
@property(class, nonatomic, strong, readonly) NSDate *appUpdateDate;
// 当前设备是否越狱, YES 是已经越狱，NO 为未越狱
@property(class, nonatomic, assign, readonly) BOOL deviceIsJailbreak;
// 当前设备是否使用网络代理, YES 是使用，NO 为未使用
@property(class, nonatomic, assign, readonly) BOOL deviceIsUseProxy;
